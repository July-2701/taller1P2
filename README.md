...
| :-------- | :------------------------------------------------------------------------------------------------ | :------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :-------: | :----------: |
| **HU-01** | Como **cajero**, quiero registrar un cliente natural con sus datos personales para aperturar una cuenta en el sistema | - El sistema valida que el documento de identidad no esté repetido.<br>- El sistema lanza `CapacidadExcedidaException` si el banco alcanzó su límite de clientes.<br>- Los datos nulos o vacíos lanzan `IllegalArgumentException`.<br>- El cliente se registra correctamente en el sistema. |    Alta   |       5      |
